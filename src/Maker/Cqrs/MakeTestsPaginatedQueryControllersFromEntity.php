...
class MakeTestsPaginatedQueryControllersFromEntity extends BaseMaker{

	public static function getCommandName(): string{
		return 'make:cqrs-test-paginated-query-from-entity';
	}
	...
	public function generate(
		...
		$testTemplates = [
			'PaginatedQueryControllerTest.tpl.php',
		];
		...
		foreach ($testTemplates as $template){
			...
			$generator->generateFile(
				...
				[
					...
					'entity_name_plural' => strtolower($entityShort) . 's/list',
